...
Revision ID: 452afbd9e874
Revises: 
Create Date: 2023-06-01 16:55:34.777274
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('students', 'moder', 'teacher', 'curator', name='usertypeoption'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('exp_token', sa.Time(), nullable=True),
